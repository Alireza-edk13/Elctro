...
export default function OfferBox({pic}) {
    return (
        <div class=" relative rounded-lg">
            <Image src={`/images/offer/${pic}`} className=' -scale-x-100 w-full rounded-lg' width={457} height={188} alt="offer-img" />
            <div class=" absolute right-0 pr-9 top-2 vsm:top-6 sm:top-9 xl:top-3 xxl:top-6">
