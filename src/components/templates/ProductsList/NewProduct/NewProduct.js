    ...
    return (
        <div className=' border border-mainBorder rounded-lg p-10 my-6'>
            ...
            <div className=' flex-center gap-2 border-b pb-4 border-mainBorder '>
                <Image src="/images/product/product-11.webp" width={100} height={100} alt="product" className=' cursor-pointer' />
                <div className=' space-y-2'>
                    <h5 className=' cursor-pointer text-main'>دوربین مداربسته</h5>
