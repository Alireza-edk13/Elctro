                ...
                <div className="container">
                    <div className=" flex  justify-evenly items-center flex-wrap">
                        ...
                        <form className=" w-full md:w-96 relative">
                            <input type="text" className=' w-full mt-12 md:mt-0 md:w-96 h-12 rounded-full text-mainBlack py-4 pr-5' placeholder="ایمیل خودتو وارد کن" className="newsleter-input" />
                            <button className=" absolute text-white flex-center bg-mainBlack rounded-full py-4 w-28 h-12 left-0 top-12 md:top-0 cursor-pointer">ارسال</button>
                        </form>
