        ...
        <div class=" group hover:shadow-custom transition-all duration-200 ease-in mb-16">
            <div class=" bg-white overflow-hidden rounded-lg px-6">
                <div className=' relative'>
                    <span class=" absolute text-sm font-normal flex-center top-3 left-0 bg-main text-white px-3.5 py-1 rounded-full z-20">جدید</span>
                ...
                <div class=" flex justify-between items-center mt-3 mb-5 relative">
                    <div>
                        ...
                        <div className=' flex-center gap-1'>
                            <div class="text-sm  line-through text-mainGray">
                               182
                            </div>
                            <div class=" text-lg font-bold flex-center gap-1 text-main mr-1 ">
                    ...
                    <div class="p-3 bg-mainBg cursor-pointer transition-all duration-200 ease-in hover:text-white hover:bg-main sm:hover:-translate-y-1 text-xl rounded-lg absolute left-0 bottom-0 product-btn addToCart">
