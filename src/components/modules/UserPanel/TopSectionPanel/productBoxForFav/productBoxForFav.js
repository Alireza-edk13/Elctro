...
export default function productBoxForFav({ _id, name, cover, orginalPrice, discount, brand, stock, categoryId, shortName, isProductBoxForProductsList = false, isProductBoxForRelatedProduct = false }) {
    return (
        <div className="group hover:shadow-custom transition-all duration-200 ease-in">
